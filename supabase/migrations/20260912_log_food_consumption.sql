-- Run after 20260912_food_consumption.sql. No new tables.
begin;
...
begin
  ...
  loop
    ...
    insert into public.food_consumption (
      ...
      v_user, p_consumed_on, p_group_id, p_meal_id, v_meal_name,
...
$$;
revoke all on function public.log_food_consumption(uuid, date, text, boolean, bigint, text, bigint, numeric, text, text)
  from public, anon, authenticated;
grant execute on function public.log_food_consumption(uuid, date, text, boolean, bigint, text, bigint, numeric, text, text)
  to authenticated;
